export declare enum DRIVING_LICENSE_CATEGORIES {
    A = "A",
    B = "B",
    C = "C",
    D = "D",
...
declare global {
    ...
    interface ID_CARD_PERSONAL_INFO extends BASE_PERSONAL_INFO {
        place_of_issue: string;
        citizenship: string;
        nationality: string;
        photo: string;
    }
    interface MILITRY_ID_CARD_INFO extends BASE_PERSONAL_INFO {
        place_of_issue: string;
        nationality: string;
        photo: string;
        /**
    ...
    interface DRIVING_LICENSE_CATEGORY {
        category: DRIVING_LICENSE_CATEGORIES;
        expiration_date: string;
        issue_date: string;
    }
    interface DRIVING_LICENSE_PERSONAL_INFO extends BASE_PERSONAL_INFO {
        license_number: string;
        expiration_date: string;
        issue_date: string;
        categories: DRIVING_LICENSE_CATEGORY[];
    }
    interface INTERNATIONAL_PASSPORT_PERSONAL_INFO extends BASE_PERSONAL_INFO {
        place_of_issue: string;
        citizenship: string;
        nationality: string;
        photo: string;
    }
    interface AUTOTRANSPORT_CARD_PERSONAL_INFO extends BASE_PERSONAL_INFO {
    }
}
